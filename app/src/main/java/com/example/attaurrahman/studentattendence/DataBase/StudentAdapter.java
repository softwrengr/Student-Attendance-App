...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.ViewHolder> {
    ...
    public StudentAdapter(List<ListHelper> listHelpers, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvFacterCNIC.setText(String.valueOf(listHelper.getStudent_roll_number()));
        holder.imageView.setImageURI(Uri.parse(listHelper.getImge_uri()));
